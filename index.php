...
<body>
    ...
    <a class="navbar-brand font-weight-bolder mr-3" href="index.php"><img src="assets/img/sukuna.jpg" width="35" height="40"></a>
    	...
    	<div class="row">
    		<div class="card-columns">
    			<div class="card card-pin">
    				<img class="card-img" src="assets/img/sukuna.jpg" alt="Card image">
    				<!-- <div class="overlay">
